        ...
        <header className="text-gray-600 body-font ">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                <span className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                    ...
                    <span className="ml-3 text-xl">Next.js Base</span>
                </span>
                <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
                    <span className="mr-5 hover:text-gray-900"><Link href="/dashboard"> Dashboard </Link></span>
                    <span className="mr-5 hover:text-gray-900">Second Link</span>
                    <span className="mr-5 hover:text-gray-900">Third Link</span>
                    <span className="mr-5 hover:text-gray-900"><Link href="/register"> Register </Link></span>
                    <span className="mr-5 hover:text-gray-900"><Link href="/login"> Login </Link></span>
                </nav>
                <div>
